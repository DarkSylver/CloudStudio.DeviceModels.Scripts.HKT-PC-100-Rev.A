...
function getEndpoints(deviceAddress, endpoints) {
    endpoints.addEndpoint("1", "Counter A", endpointType.peopleCounter);
    endpoints.addEndpoint("2", "Counter B", endpointType.peopleCounter);
    endpoints.addEndpoint("3", "Total Counter A", endpointType.peopleCounter);
    endpoints.addEndpoint("4", "Total Counter B", endpointType.peopleCounter);
    var battery = endpoints.addEndpoint("5", "Battery", endpointType.genericSensor);
    battery.variableTypeId = 1277;
